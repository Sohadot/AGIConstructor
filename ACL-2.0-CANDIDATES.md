...
**Type: additive-to-breaking (reporting).** The [Construction Ontology](./CONSTRUCTION_ONTOLOGY.md) groups the eight into three families (constitutive substrate / integrative mechanisms / control and assurance). ACL-1.0's flat list does not encode this. A future version could make family-awareness part of the report so "8/8" cannot be read as eight measurements of the same kind.
